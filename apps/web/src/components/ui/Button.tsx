...
const VARIANTS: Record<ButtonVariant, string> = {
  primary:     'px-4 py-2 rounded-lg bg-primary hover:bg-primary-hover text-white',
  ...
  accent:      'px-4 py-2 rounded-lg bg-accent hover:bg-accent-hover text-slate-900 font-semibold',
}
