...
function HotRow({ entry, workoutId }: { entry: WorkoutResult; workoutId: string }) {
  ...
  return (
    <div
      ...
      className="flex items-center gap-3 px-4 py-2.5 cursor-pointer hover:bg-slate-50 dark:hover:bg-gray-800/40 transition-colors"
    >
      ...
      <span className="shrink-0 text-xs tabular-nums text-slate-500 dark:text-gray-400">{score}</span>
