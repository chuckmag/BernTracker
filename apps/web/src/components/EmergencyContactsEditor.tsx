    ...
    <div className="space-y-3">
      {contacts.length > 0 && (
        <ul className="space-y-2">
          {contacts.map((c) => (
            <li key={c.id} className="flex items-start justify-between gap-3 rounded-lg bg-gray-800 px-3 py-2">
      ...
      <div className="space-y-2 rounded-lg bg-gray-800 p-3">
        <p className="text-xs text-gray-400">Add a contact</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <input
            ...
            className="bg-gray-900 border border-gray-700 rounded px-2 py-1.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
          <input
            type="text"
