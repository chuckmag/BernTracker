...
const mockTrajectory: StrengthTrajectoryData = {
  ...
  loadUnit: 'LB',
  points: [
    { date: '2026-02-01', maxLoad: 205, loadUnit: 'LB', effort: '5 × 205', e1rm: 205, workoutId: 'w-1', resultId: 'r-1' },
    { date: '2026-03-01', maxLoad: 215, loadUnit: 'LB', effort: '3 × 215', e1rm: 215, workoutId: 'w-2', resultId: 'r-2' },
    { date: '2026-04-01', maxLoad: 225, loadUnit: 'LB', effort: '1 × 225', e1rm: 225, workoutId: 'w-3', resultId: 'r-3' },
  ],
}
...
describe('Analytics', () => {
  ...
  it('shows current PR and improvement chip after trajectory loads', async () => {
    ...
    expect(await screen.findByText(/\+20 e1RM/)).toBeInTheDocument()
  })
