...
const MOVEMENTS: SeedMovement[] = [
  ...
  { name: 'Barbell Front-rack Lunge',        sourceUrl: 'https://www.crossfit.com/essentials/barbell-front-rack-lunge' },
  ...
  { name: 'Box Step-up',                     sourceUrl: 'https://www.crossfit.com/essentials/the-box-step-up' },
  { name: 'Burpee',                          sourceUrl: 'https://www.crossfit.com/essentials/the-burpee-2' },
  { name: 'Burpee Box Jump-over',            sourceUrl: 'https://www.crossfit.com/essentials/the-burpee-box-jump-over',      aliases: ['BBJO'] },
  ...
  { name: 'Clean',                           sourceUrl: 'https://www.crossfit.com/essentials/the-clean-2' },
  { name: 'Clean and Jerk',                  sourceUrl: 'https://www.crossfit.com/essentials/the-clean-and-jerk',            aliases: ['C&J', 'CJ'] },
  ...
  { name: 'Double-under',                    sourceUrl: 'https://www.crossfit.com/essentials/the-double-under',              aliases: ['DU', 'doubles'] },
  ...
  { name: 'Handstand Push-up Variations',    sourceUrl: 'https://www.crossfit.com/essentials/handstand-push-up-variations',  aliases: ['HSPU'] },
  { name: 'Handstand Walk',                  sourceUrl: 'https://www.crossfit.com/essentials/the-handstand-walk',            aliases: ['HSW'] },
  { name: 'Hang Clean',                      sourceUrl: 'https://www.crossfit.com/essentials/the-hang-squat-clean',          aliases: ['HC'] },
  ...
  { name: 'Hang Snatch',                     sourceUrl: 'https://www.crossfit.com/essentials/the-hang-snatch',               aliases: ['HSN'] },
  // I
  ...
  { name: 'Kettlebell Swing',                sourceUrl: 'https://www.crossfit.com/essentials/the-kettlebell-swing',          aliases: ['KBS', 'KB swing'] },
  { name: 'Kipping Bar Muscle-up',           sourceUrl: 'https://www.crossfit.com/essentials/the-kipping-bar-muscle-up',     aliases: ['BMU', 'bar muscle-up'] },
  { name: 'Kipping Chest-to-bar Pull-up',    sourceUrl: 'https://www.crossfit.com/essentials/the-kipping-chest-to-bar-pull-up', aliases: ['C2B', 'CTB', 'chest-to-bar'] },
  { name: 'Kipping Deficit Handstand Push-up', sourceUrl: 'https://www.crossfit.com/essentials/the-kipping-deficit-handstand-push-up', aliases: ['deficit HSPU'] },
  ...
  { name: 'Kipping Muscle-up',               sourceUrl: 'https://www.crossfit.com/essentials/the-kipping-muscle-up',         aliases: ['MU', 'muscle-up'] },
  { name: 'Kipping Pull-up',                 sourceUrl: 'https://www.crossfit.com/essentials/the-kipping-pull-up' },
  { name: 'Kipping Toes-to-bar',             sourceUrl: 'https://www.crossfit.com/essentials/the-kipping-toes-to-bar',       aliases: ['T2B', 'TTB', 'toes to bar'] },
  // L
  ...
  { name: 'Single-under',                    sourceUrl: 'https://www.crossfit.com/essentials/the-single-under',              aliases: ['singles'] },
  ...
  { name: 'Snatch',                          sourceUrl: 'https://www.crossfit.com/essentials/the-snatch' },
  ...
  { name: 'Strict Knees-to-elbows',          sourceUrl: 'https://www.crossfit.com/essentials/the-strict-knees-to-elbow',     aliases: ['K2E', 'knees to elbows'] },
  { name: 'Strict Muscle-up',                sourceUrl: 'https://www.crossfit.com/essentials/the-strict-muscle-up',          aliases: ['strict MU'] },
  { name: 'Strict Pull-up',                  sourceUrl: 'https://www.crossfit.com/essentials/the-strict-pull-up' },
  ...
  // W
  { name: 'Walking Lunge',                   sourceUrl: 'https://www.crossfit.com/essentials/the-walking-lunge',             aliases: ['lunge'] },
